...
<!--
build with:
rmarkdown::render("Data/Download_datasets.Rmd")
--!>
...
#base_dir <- "."
#dir.create(file.path(base_dir,"Benchmark/Data"))
#dir.create(file.path(base_dir,"Benchmark/Data/sce"))
data_dir <- here("Benchmark/Data/sce")
```
