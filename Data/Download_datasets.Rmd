...
```{r}
download.file("https://figshare.com/ndownloader/files/10756798?private_link=865e694ad06d5857db4b", "MCA_500more_dge/MCA_500more_dge.tar.gz")
...
download.file("https://figshare.com/ndownloader/files/11083451?private_link=865e694ad06d5857db4b","MCA_500more_dge/MCA_CellAssignments.csv")
...
dim(data_combined)
coldata = small_intestine %>% mutate(batch = as.factor(Batch), celltype = as.factor(Annotation))
